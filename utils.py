...
class Education:
    def __init__(self, education_name='N/A', degree_name='N/A', major='N/A', year='N/A'):
...
class Profile:
    def __init__(self, profile_name, headline, location, connection, connectedDate, phone,
                        birthday, profile_desc, email, skills, last_job=Job(), job_history_summary=JobHistorySummary(), education=Education()):
